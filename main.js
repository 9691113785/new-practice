...
function addcard(){
    ...
    popvalue = document.getElementById('input-box').value
    todo = `
    <div id="item-1" class="items">
                <div id="para-list">
                <h1 id="adding-item" class="header">${popvalue}</h1>
                 <hr>
                
              </div>
              <div class="delete-add">
               <i id="delete-icon" class="fa-solid fa-trash-can deletetask"></i>
               <i id="below-plus-icon" class="fa-solid fa-circle-plus"></i>
              </div>
              </div>
    `

    maindisplay.innerHTML += todo
...
var taskarr = document.querySelectorAll('.items')


var delarr = document.querySelectorAll('.deletetask')
var arr = document.querySelectorAll('.header')
